        ...
        <div className="kitchenPageContainer">
          ...
          <div className="kitchenPageRight">
            <div className="processContainer">
              <h2 className="process">Step by Step Process</h2>
            </div>
            <div className="boxesContainer">
              ...
              <div className="BoxCon">
                ...
                <div className="steptitle">
                  ...
                  <p className="stepsList">
                    ...
                    process. We'll also discuss plumbing, electrical changes,
                    and flooring plans.
                  </p>
                </div>
              </div>
              ...
              <div className="BoxCon">
                ...
                <div className="steptitle">
                  <h3>Installation</h3>
                  <p className="stepsList">
                    The exciting final step! We'll install your pre-built
                    cabinets within a week for a stress-free experience.
                  </p>
                </div>
              </div>
            </div>
